  ...
  return (
    <div>
      <Menu as="div" className="inline-block text-left">
        <div className="flex">
          <Menu.Button className="inline-flex gap-2 w-full rounded-md bg-white md:px-4 py-2 text-sm font-medium text-slate-700 hover:bg-opacity-20">
            ...
            <img
              src={user?.profileUrl}
              alt="user profile"
              className="w-10 h-10 rounded-full 0bject-cover"
            />
            <BiChevronDown className="h-8 w-8 text-slate-600" aria="true" />
          </Menu.Button>
        </div>
        <Transition
          as={Fragment}
        ...
        >
          <Menu.Item className="absolute z-50 right-2 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg focus:outline-none">
            <div className="p-1">
              {/* profile button  */}
...
const Navbar = () => {
  ...
  const handleCloseNavbar = () => {
    setIseOpen((prev) => !prev);
  };
  return (
    <>
      <div className="realtive bg-[#f7fdfd] z-50">
