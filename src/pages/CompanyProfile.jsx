                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <textarea className="rounded border border-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-base pxx-4 py-2 resize-none" cols={6} rows={4}
                        {...register("about", {
...
function CompanyProfile() {
  ...
  return (
    <div className="px-10 container mx-auto p-5">
      <div className="">
      ...
      <div className="w-full mt-20 flex flex-col gap-1">
        <p>Jobs Posted</p>
